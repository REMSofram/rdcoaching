-- Suppression de la colonne color de la table calendar_cards
ALTER TABLE public.calendar_cards DROP COLUMN IF EXISTS color;

-- Recréation de la vue calendar_cards_with_info pour refléter les changements
